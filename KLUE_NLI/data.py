...
def load_data(path, ratio = 0):
    ...
    if ratio > 0:
        ...
        return Dataset.from_pandas(train_data)

def preprocess_function(examples : datasets, tokenizer, model_args) -> datasets:
    ...
    if model_args.use_SIC:
        ...
        model_inputs = tokenizer(premise, hypothesis, truncation=True, return_token_type_ids = False)
